...
public interface HCNetSDK extends StdCallLibrary {
    ...
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("C:\\Users\\Thinkpad-W530\\Desktop\\CH-HCNetSDKV6.1.6.45_build20210302_win64\\sdk\\HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    public static final int ENUM_SENDDATA = 0x0;
...
//NET_DVR_Login()参数结构
    ...
    public static class LPNET_DVR_SETUPALARM_PARAM extends Structure
    {
        public int dwSize;
        public byte byLevel; //布防优先级，0-一等级（高），1-二等级（中），2-三等级（低）
        public byte byAlarmInfoType; //上传报警信息类型（抓拍机支持），0-老报警信息（NET_DVR_PLATE_RESULT），1-新报警信息(NET_ITS_PLATE_RESULT)2012-9-28
    ...
    */
    ...
    public static class NET_DVR_ACS_EVENT_DETAIL extends Structure {
        ...
        public byte byCardType;
        public byte byAllowListNo; //名单单号,1-8，为0无效
...
//	public NET_ITC_REDLIGHT_PEDESTRIAN_PARAM struRedLightPed = new NET_ITC_REDLIGHT_PEDESTRIAN_PARAM();//行人闯红灯参数
    ...
    public static interface MSGCallBack extends StdCallCallback {
        public boolean invoke(int lCommand, NET_DVR_ALARMER pAlarmer, Pointer pAlarmInfo, int dwBufLen, Pointer pUser);
    }
    ...
    int  NET_DVR_SetupAlarmChan_V41(int lUserID,   LPNET_DVR_SETUPALARM_PARAM lpSetupParam);
...
//透明通道设置
    ...
    boolean NET_DVR_FindBackgroundPic(int lUserID,int dwPicID, byte[] pPicBuffer,int dwPicLen);
...
//2007-11-30 V211支持以下接口 //11
    ...
    int NET_DVR_GetUploadState(int lUploadHandle, 	IntByReference pInt);
