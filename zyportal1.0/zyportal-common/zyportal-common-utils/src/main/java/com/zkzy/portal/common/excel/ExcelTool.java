package com.zkzy.portal.common.excel;


import com.zkzy.portal.common.excel.annotation.ExcelField;
import com.zkzy.portal.common.excel.annotation.ExcelSheet;
import com.zkzy.portal.common.excel.util.FieldReflectionUtil;
...
public class ExcelTool {
     ...
     * 导出Excel对象
     *
     * @param xlsx             true  = xlxs 、 false = xls
     *                         * @param sheetDataListArr Excel-Sheet数据；两层List，外层List对应多张Sheet，内层List对应单个Sheet内的多条数据；
     * @return Workbook
     */
    public static Workbook exportWorkbook(boolean xlsx, List<List<?>> sheetDataListArr) {
    ...
    public static void makeSheet(Workbook workbook, List<?> sheetDataList) {
        // data
