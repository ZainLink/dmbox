...
public class UserAgentUtil {
    ...
    public static UserAgent getUserAgent(String userAgent) {
        ...
        if (userAgent.contains("Windows")) {//主流应用靠前
             ...
             */
            if(userAgent.contains("Windows NT 10.0")){//Windows10
    ...
    private static UserAgent judgeBrowser(String userAgent, String platformType, String platformSeries, String platformVersion) {
        if (userAgent.contains("OPR")) {//opera
            String chromeVersion = userAgent.substring(userAgent.indexOf("OPR/")+4);
            ...
            if (userAgent.contains("MSIE 10.0")) {//Internet Explorer 10
                return new UserAgent("IE", "10", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 9.0")) {//IE 9
                return new UserAgent("IE", "9", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 8.0")) {//IE 8
                return new UserAgent("IE", "8", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 7.0")) {//IE 7
                return new UserAgent("IE", "7", platformType, platformSeries, platformVersion);
            } else if (userAgent.contains("MSIE 6.0")) {//IE 6
                return new UserAgent("IE", "6", platformType, platformSeries, platformVersion);
            }
