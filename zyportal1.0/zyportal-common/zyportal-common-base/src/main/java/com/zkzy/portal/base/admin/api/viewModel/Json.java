...
public class Json {
    ...
    private List<SystemDepartment> departmentList;
    ...
    public List<SystemDepartment> getDepartmentList() {
        return departmentList;
    }

    public void setDepartmentList(List<SystemDepartment> departmentList) {
